...
<head>
   ...
   <!-- THIS WILL COME DYNAMICALLY FROM WORDPRESS -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-10 logo-holder">
                        <div class="logo">
                            <a href="home.html"> <img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/images/logo.png" alt="logo"> </a>
                        </div>
                    </div>
                                ...
                                <li>
                                    <div class="cart-item product-summary">
                                        <div class="row">
                                            <div class="col-xs-4">
                                                <div class="image">
                                                    <a href="detail.html"><img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/images/cart.jpg" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-xs-7">
                                                    ...
                                                    <div class="yamm-content">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner">
                                                                <a href="#"><img alt="" src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/images/banners/banner-side.png"></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            </ul>
